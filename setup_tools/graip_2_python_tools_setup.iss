...
; 1. GRAIP Tools.tbx
; 2. GRAIP.mdb
; 3. GRAIPPreprocessor.exe
; 4. demo.zip
; 5. consolidateShp.dll
; 6. MSCOMCTL.OCX
; 7. mshflxgd.ocx
; 8. comdlg32.ocx        
...
; StabilityIndex tool got moved to TauDEM Toolbox
...
Source: "SourceFiles\ArcGISAddStabilityIndexToDatabase.py"; DestDir: "{app}\PythonTools"; Flags: ignoreversion
...
Source: "SourceFiles\AddStabilityIndexToDatabase.py"; DestDir: "{app}\PythonTools"; Flags: ignoreversion
...
begin
  notes_string_1 := 'NOTES:With the installation of GRAIP-2 Python tools, the following python scripts are installed:'#13 +
      ...
      '4. ArcGISAddStabilityIndexToDatabase.py: ArcGIS Toolbox Add Stability Index interface to Add Stability Index function'#13 +
      ...
      '6. ArcGISMassWasting.py: ArcGIS Toolbox Mass Wasting Potential Analysis interface to Mas Wasting Potential function'#13 +
      '7. ArcGISLSPlot.py: ArcGIS Toolbox Length Slope Plot interface to Length Slope Plot function';
  ...
  notes_string_2 := '8. RoadSurfaceErosion.py: Command line callable Road Surface Erosion function'#13 +
      ...
      '12. AddStabilityIndexToDatabase.py: Command line callable Add Stability Index to Database function'#13 +
      '13. MassWastingPotential.py: Command line callable Mas Wasting Potential function'#13 +
      '14. LSPlot.py: Command line callable Length Slope Plot function'#13#13 +
